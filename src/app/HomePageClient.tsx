  ...
  return (
    <div className="bg-[#1A1A1A]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5 mb-16">
            {verticals.map((v, i) => {
              ...
              const sectionImages = [
                ...
                '/images/sections/comp-water-plant.jpg',
              ];
      ...
      <section className="photo-section relative min-h-[40vh] flex items-center justify-center">
        <Image src="/images/sections/comp-mining-excavator.jpg" alt="Harch Corp Industrial Operations" fill className="object-cover industrial-image" />
      ...
      <section className="photo-section relative min-h-[70vh] flex items-center">
        <Image
          src="/images/sections/comp-energy-solar.jpg"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <FadeIn>
              <div className="relative w-full aspect-[4/3] overflow-hidden rounded-2xl bg-[#1E1E1E] image-reveal">
                <Image src="/images/sections/comp-intel-tech.jpg" alt="Harch Intelligence AI Data Center" fill className="object-cover industrial-image" />
      ...
      <section className="photo-section relative min-h-[70vh] flex items-center">
        <Image
          src="/images/sections/comp-mining-excavator.jpg"
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <FadeIn className="order-1 lg:order-2">
              <div className="relative w-full aspect-[4/3] overflow-hidden rounded-2xl bg-[#1E1E1E] image-reveal">
                <Image src="/images/sections/comp-energy-solar.jpg" alt="Harch Energy Solar Farm" fill className="object-cover industrial-image" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent" />
                <div className="absolute bottom-4 left-4 bg-[#000000]/70 backdrop-blur-md px-4 py-2 rounded-lg border border-[rgba(255,255,255,0.06)]">
