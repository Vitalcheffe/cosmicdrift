...
const locations: MapLocation[] = [
  ...
  { id: 'gambia', name: 'Banjul', vertical: 'Ciment', version: '/0.2', stat: '500kT/yr Production', desc: 'Vertically Integrated Cement Plant', xPercent: 6.5, yPercent: 23, status: 'permitted' },
