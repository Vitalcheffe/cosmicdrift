      ...
      competitors: [
        {
          ...
          verdict: 'Dangote produces volume. Harch Cement produces the future — green LC3 cement at 30-50% below import prices, powered by 100% renewable energy, with zero water waste. Volume without sustainability is the past.',
        },
        {
          name: 'Holcim (ECOPact)',
          country: 'Switzerland',
          metrics: [
            ...
            { label: 'Renewable Energy', harchValue: '100% Harch Energy', competitorValue: 'Partial — no African supply chain', harchWins: true },
          ...
          verdict: 'Holcim makes ECOPact in Zurich. Harch Cement makes green cement in Gambia — at a cost advantage, not a premium, with 100% renewable energy and 800 local jobs. We are where Holcim left.',
        },
        {
          name: 'Dalmia Cement',
          country: 'India',
          ...
          verdict: 'Dalmia validates LC3 technology — and we follow the same path. But Dalmia sells cement in a saturated Indian market. Harch Cement builds a nation\'s first domestic supply from zero, powered by our own energy, in the fastest-growing construction market on Earth.',
        },
      ],
    },
    energy: {
      ...
      competitors: [
        {
          ...
          verdict: 'ACWA builds power plants. Harch Energy powers an industrial ecosystem — every MWh feeds a Harch subsidiary, every H2 molecule feeds a Harch process. ACWA sells energy. We are energy.',
        },
        {
          name: 'Masdar',
          country: 'Abu Dhabi',
          ...
          verdict: 'Masdar has UAE capital. Harch Energy has African integration — every MWh powers a Harch subsidiary, every dollar stays on the continent. Capital without integration is just money. Integration without capital is a strategy. We have both.',
        },
        {
          ...
          verdict: 'Fortescue announced 15GW and cancelled half of it. Harch Energy announces 200MW and ships every watt. Execution beats announcements. Discipline beats scale.',
        },
      ],
    },
    technology: {
      ...
      competitors: [
        {
          ...
          verdict: 'Liquid C2 resells Google Cloud under an African flag. Harch Technology builds sovereign infrastructure — every GPU, every byte, every policy under African control, with SOC 2 certification no African competitor holds.',
        },
        {
          ...
          verdict: 'Dimension Data has offices in 14 African countries. Harch Technology has the only African sovereign AI platform, the only African edge network, and the only African satellite integration. Presence without sovereignty is just real estate.',
        },
        {
          name: 'Starlink',
          country: 'USA (SpaceX)',
      ...
      competitors: [
        {
          ...
          verdict: 'Glencore mines more cobalt. Harch Mining mines smarter — 100% renewable, 80% lower carbon, 5-8x value capture, green premium eligible from day one. Volume without ESG is a liability.',
        },
        {
          name: 'OCP Group',
          country: 'Morocco',
    ...
    water: {
      ...
      competitors: [
        ...
        },
        {
          ...
          verdict: 'Veolia builds the biggest desal plant in Africa at 2x our cost and 3x our energy use, losing 20% of water in distribution. Harch Water builds the smartest — 40% cheaper, 60% less energy, 8x fewer network losses, with 10% free for communities. Smart beats big.',
        },
        {
          ...
          metrics: [
            ...
            { label: 'AI Distribution', harchValue: 'Proprietary platform', competitorValue: 'None', harchWins: true },
            { label: 'Community Allocation', harchValue: '10% free', competitorValue: '0%', harchWins: true },
