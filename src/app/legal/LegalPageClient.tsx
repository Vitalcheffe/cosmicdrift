    ...
    <div className="bg-white">
      <section className="pt-32 pb-24 md:pt-40 md:pb-32">
        <div className="max-w-[900px] mx-auto px-6 md:px-12">
          ...
          <h1 className="text-4xl sm:text-5xl font-semibold text-[#101820] tracking-tight mb-12">
            Legal Mentions
          </h1>

          <div className="space-y-8 text-sm text-[#6B7280] leading-relaxed">
            <div>
              <h2 className="text-lg font-medium text-[#101820] mb-3">Company Information</h2>
              <p>
            ...
            <div>
              <h2 className="text-lg font-medium text-[#101820] mb-3">Data Protection Officer</h2>
              <p>
            ...
            <div>
              <h2 className="text-lg font-medium text-[#101820] mb-3">Website Publisher</h2>
              <p>
            ...
            <div>
              <h2 className="text-lg font-medium text-[#101820] mb-3">Hosting</h2>
              <p>
            ...
            <div>
              <h2 className="text-lg font-medium text-[#101820] mb-3">Intellectual Property</h2>
              <p>
            ...
            <div>
              <h2 className="text-lg font-medium text-[#101820] mb-3">Limitation of Liability</h2>
              <p>
            ...
            <div>
              <h2 className="text-lg font-medium text-[#101820] mb-3">Applicable Law</h2>
              <p>
