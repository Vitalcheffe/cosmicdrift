          ...
          <div className="space-y-0">
            {documents.map((doc, i) => (
              <FadeIn key={doc.name} delay={i * 0.05}>
                <div className="flex items-center justify-between py-5 border-b border-[rgba(0,0,0,0.04)] group cursor-pointer hover:bg-[rgba(0,0,0,0.02)] transition-colors">
                  <div className="flex items-center gap-4">
                    <Download size={16} className="text-[#9CA3AF]" />
                    <div>
                      <p className="text-sm text-[#0A0F1A]/60 group-hover:text-[#0A0F1A] transition-colors">
                        {doc.name}
                      </p>
                  ...
                  <ArrowRight size={14} className="text-[rgba(0,0,0,0.1)] group-hover:text-[rgba(0,0,0,0.3)] transition-colors" />
                </div>
              </FadeIn>
            ))}
          </div>
