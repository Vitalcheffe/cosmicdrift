...
import (
    "fmt"
    "github.com/harchcorp/harchos-sdk-go"
)
    ...
    <div className="bg-[#1A1A1A]">
      ...
      <section className="relative pt-32 pb-16 md:pt-40 md:pb-20">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-12">
          ...
          <FadeIn delay={0.1}>
            <p className="section-label mb-6 text-[#06B6D4]">API Playground /0.3</p>
            <h1 className="text-5xl md:text-7xl lg:text-[80px] font-extrabold text-white tracking-[-0.03em] leading-[0.95] mb-6">
              API Playground<span className="text-[#06B6D4]">.</span>
            </h1>
          </FadeIn>
          <FadeIn delay={0.2}>
                      ...
                      <button
                        ...
                        className={`w-full text-left px-4 py-3 rounded-lg transition-all text-[13px] ${
                          activeGroup === group.id
                            ? 'bg-[rgba(6,182,212,0.08)] text-white border border-[rgba(6,182,212,0.15)]'
                  ...
                  <div className="flex items-center gap-3 px-6 py-4 border-b border-white/[0.04] bg-[rgba(255,255,255,0.02)]">
                    <div className="relative">
                      <select
                        ...
                        className="appearance-none bg-transparent text-[12px] font-bold font-[family-name:var(--font-space-mono)] px-3 py-1.5 rounded border border-white/[0.08] pr-7 cursor-pointer focus:outline-none focus:border-[#06B6D4]/50"
                    ...
                    />
                    <button className="inline-flex items-center gap-2 bg-[#06B6D4] text-black px-5 py-2 rounded-lg text-[12px] font-bold hover:bg-[#06B6D4]/90 transition-all">
                      <Play size={12} /> Send
                    </button>
                  </div>
                  ...
                  <div className="border-b border-white/[0.04]">
                    <div className="flex px-6">
                      {['Headers', 'Body', 'Auth'].map((tab) => (
                        <button
                          key={tab}
                          className="px-4 py-3 text-[12px] font-semibold text-[#999999] hover:text-white border-b-2 border-transparent transition-all first:border-b-2 first:border-[#06B6D4] first:text-white"
                        >
                          {tab}
                        </button>
                      ))}
