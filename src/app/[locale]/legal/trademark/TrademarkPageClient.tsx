          ...
          <div className="space-y-10">
            ...
            <FadeIn delay={0.3}>
              ...
              <div className="border border-[rgba(255,255,255,0.06)] rounded-lg p-5 bg-[#1E1E1E]">
                ...
                <p className="text-[14px] text-[#999999]">{t('trademark.requestEmailLabel')} <a href="mailto:brand@harchcorp.com" className="text-white hover:underline">brand@harchcorp.com</a></p>
