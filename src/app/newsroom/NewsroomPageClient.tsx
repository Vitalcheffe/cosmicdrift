          ...
          <div className="space-y-0">
            {articles.map((article, i) => (
              <FadeIn key={article.title} delay={i * 0.05}>
                <div
                  className="py-8 border-b border-[rgba(0,0,0,0.04)] group cursor-pointer hover:bg-[rgba(0,0,0,0.02)] transition-colors"
                >
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-[#0A0F1A] group-hover:text-[#0A0F1A] transition-colors mb-3">
                    {article.title}
                  </h3>
