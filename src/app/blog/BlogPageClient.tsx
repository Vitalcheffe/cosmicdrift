    ...
    <div className="bg-[#1A1A1A]">
      ...
      <section className="pt-32 pb-20 md:pt-40 md:pb-28 bg-[#1A1A1A]">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          <FadeIn>
            <p className="section-label mb-4 text-[#06B6D4]">Blog</p>
                ...
                <FadeIn key={post.slug} delay={i * 0.06}>
                  <div className="card p-6 h-full flex flex-col group cursor-pointer">
                    <div className="flex items-center gap-3 mb-4">
                      <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md bg-[rgba(6,182,212,0.06)] border border-[rgba(6,182,212,0.1)] text-[9px] font-bold tracking-[0.12em] uppercase text-[#06B6D4]">
      ...
      <section className="py-28 md:py-36 bg-[#121212]">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          <div className="max-w-2xl mx-auto text-center">
            <FadeIn>
              <Mail size={32} className="text-[#06B6D4] mx-auto mb-6" strokeWidth={1.5} />
              <p className="section-label mb-4 text-[#06B6D4]">Newsletter</p>
              ...
              {subscribed ? (
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <input
                    ...
                    className="flex-1 px-4 py-3 rounded-lg bg-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.08)] text-white text-[14px] placeholder-[#666666] focus:outline-none focus:border-[rgba(6,182,212,0.3)] transition-colors font-[family-name:var(--font-space-mono)]"
                  />
                  <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <FadeIn>
              <div className="card p-8 md:p-10 h-full group cursor-pointer">
                <PenLine size={20} className="text-[#06B6D4] mb-4" strokeWidth={1.5} />
