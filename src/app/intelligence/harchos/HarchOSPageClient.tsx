        ...
        competitors={[
          {
            ...
            country: 'USA',
            metrics: [
              { label: 'Carbon-Aware GPU Scheduling', harchValue: 'Real-time, per-job', competitorValue: 'None', harchWins: true },
              { label: 'African Sovereign DC', harchValue: 'Yes — 5 hubs, Morocco', competitorValue: 'None in Africa', harchWins: true },
              { label: 'Uptime SLA', harchValue: '99.999% (5-nines)', competitorValue: '99.99% (4-nines)', harchWins: true },
              { label: 'Renewable Energy', harchValue: '81.5% avg (97.2% best hub)', competitorValue: '0% disclosed', harchWins: true },
              { label: 'Carbon Intensity', harchValue: '~47 gCO2/kWh', competitorValue: '~400+ gCO2/kWh (US grid)', harchWins: true },
              { label: 'PUE', harchValue: '<1.15 (1.04 best hub)', competitorValue: 'Undisclosed', harchWins: true },
              { label: 'Submarine Cable Hub', harchValue: '4 systems, 8ms to EU', competitorValue: 'None', harchWins: true },
              { label: 'Sovereign Compliance', harchValue: 'GDPR + ISO 27001 + SOC 2 + Law 09-08', competitorValue: 'US jurisdiction only', harchWins: true },
              { label: 'Energy Cost /kWh', harchValue: '$0.03', competitorValue: '$0.08-0.12', harchWins: true },
              { label: 'Data Residency Guarantee', harchValue: '100% African', competitorValue: 'US-controlled', harchWins: true },
            ],
            verdict: 'CoreWeave has more GPUs. HarchOS has everything else — carbon-aware scheduling, African sovereignty, 10x lower energy cost, 5-nines SLA, and 8x lower carbon intensity. Scale without sovereignty is just rented infrastructure.',
          },
          {
            ...
            metrics: [
              ...
              { label: 'GPU Cloud Access', harchValue: 'Yes — H100/A100/L40S', competitorValue: 'No — internal only', harchWins: true },
              ...
              { label: 'EU CBAM Compliance', harchValue: 'Zero-margin — already green', competitorValue: 'N/A — but no GPU access', harchWins: true },
              { label: 'Submarine Cable Gateway', harchValue: '4 systems, Africa-EU hub', competitorValue: 'Nordic — no Africa path', harchWins: true },
            ],
            verdict: 'Google Hamina is a green data center you cannot use. HarchOS is a green GPU cloud you can — at 50% lower energy cost, with African sovereignty, and real-time carbon-aware scheduling. Access matters.',
          },
          {
            name: 'Africa Data Centres (Cassava)',
            country: 'South Africa',
            metrics: [
              { label: 'GPU Compute', harchValue: '1,798 GPUs (H100/A100/L40S)', competitorValue: '0 GPUs', harchWins: true },
              ...
              { label: 'Sovereign AI Platform', harchValue: 'Full-stack (train/tune/serve)', competitorValue: 'None', harchWins: true },
              { label: 'PUE', harchValue: '<1.15 (1.04 best hub)', competitorValue: 'Undisclosed', harchWins: true },
            ...
            verdict: 'Africa\'s largest DC operator has zero GPUs, zero carbon-awareness, zero AI platform, and 17x less power pipeline. HarchOS is not competing with Africa Data Centres — we are in a different category entirely.',
          },
          {
            name: 'QScale',
            country: 'Canada',
            metrics: [
              { label: 'Carbon-Aware Scheduling', harchValue: 'Real-time per-job routing', competitorValue: 'None', harchWins: true },
              { label: 'GPU Cloud (Accessible)', harchValue: 'Yes — on-demand + reserved', competitorValue: 'Colocation only', harchWins: true },
              ...
              { label: 'Energy Cost /kWh', harchValue: '$0.03', competitorValue: '$0.04-0.05 (Hydro-Quebec)', harchWins: true },
              { label: 'Sovereign Compliance', harchValue: 'GDPR + ISO 27001 + SOC 2', competitorValue: 'Canadian jurisdiction', harchWins: true },
            ],
            verdict: 'QScale runs on a clean grid but cannot schedule carbon, cannot serve GPU workloads, cannot reach Europe in under 80ms, and cannot offer African sovereignty. HarchOS is the only platform that combines carbon-awareness + GPU access + EU proximity + African sovereignty.',
          },
        ]}
      />
