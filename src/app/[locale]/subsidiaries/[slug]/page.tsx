...
const subsidiaryMetaEn: Record<string, {
  ...
  intelligence: {
    title: 'Carbon-Aware GPU Cloud & Sovereign AI Infrastructure',
  ...
  cement: {
    title: '500kT/yr Green Cement Production in Gambia',
  ...
  energy: {
    title: '2GW+ Renewable Energy Pipeline Across Africa',
  ...
  technology: {
    title: 'Sovereign Digital Infrastructure & Cybersecurity',
  ...
  mining: {
    title: 'Strategic Mineral Processing & Value Capture in Africa',
  ...
  agriculture: {
    title: 'Precision Agriculture & Vertical Farming Across the Sahel',
  ...
  finance: {
    title: 'Green Bonds, Project Finance & Islamic Finance for Africa',
...
const subsidiaryMetaFr: Record<string, {
  ...
  intelligence: {
    title: 'Cloud GPU Conscient du Carbone & Infrastructure IA Souveraine',
  ...
  cement: {
    title: '500kT/an de Production de Ciment Vert en Gambie',
  ...
  energy: {
    title: 'Pipeline d\'Énergie Renouvelable 2 GW+ à travers l\'Afrique',
  ...
  technology: {
    title: 'Infrastructure Numérique Souveraine & Cybersécurité',
  ...
  mining: {
    title: 'Traitement Minéral Stratégique & Captation de Valeur en Afrique',
  ...
  agriculture: {
    title: 'Agriculture de Précision & Agriculture Verticale à travers le Sahel',
  ...
  finance: {
    title: 'Obligations Vertes, Financement de Projets & Finance Islamique pour l\'Afrique',
