...
export const articles: Article[] = [
  {
    ...
    date: 'March 15, 2026',
    tag: 'Intelligence',
    excerpt: '50 hectares. 500MW. 50,000+ GPUs. Harch Intelligence breaks ground on the infrastructure that ends Africa\'s compute dependency — permanently.',
...
<p>The global AI compute market will exceed $400 billion by 2030. The question was never whether Africa would participate — the question was on whose terms. Harch Intelligence's Dakhla facility answers that question definitively: on Africa's terms, on African soil, with African infrastructure.</p>`,
  ...
  },
  {
    ...
    title: '2GW and Counting: The Energy Backbone of a Continent',
    ...
    body: `<p>Two gigawatts. That's enough to power a small country — or, more precisely, enough to power the industrial infrastructure that makes a continent sovereign. Harch Energy has crossed the 2GW mark in its active development pipeline, and the implications extend far beyond electricity.</p>
...
<p>The allocation reads like a blueprint for continental sovereignty. Harch Intelligence: $800M for 500MW of sovereign AI compute — the largest single allocation, because compute is the foundation on which everything else runs. Harch Energy: $600M for 2GW+ of renewable generation — because sovereign compute without sovereign energy is a contradiction. Harch Technology: $400M for AI platforms, cybersecurity, and satellite communications — because infrastructure without a sovereign tech stack is just hardware waiting to be compromised. Harch Ciment: $200M for 500kT/yr production in Gambia — because you cannot build a continent without building materials. Mining, Agri, and Water split the remaining $400M, each targeting structural deficits that foreign investment has systematically ignored.</p>
...
<p>The numbers tell the story. Domestically produced cement: $65-75 per tonne. Imported cement: $120 per tonne. On an annual import volume of 400,000 tonnes, that's a $20+ million annual wealth transfer from Gambia to foreign producers. Harch Ciment's facility recaptures that value and keeps it on the continent.</p>
...
<p>50 enterprise clients targeted by end of 2026. General availability Q2 2027. A research access tier provides subsidized compute to African universities — because building the next generation of AI talent is not charity, it's strategy.</p>`,
  ...
  },
  {
    ...
    title: 'Harch Energy × MASEN: Building the Hydrogen Economy Europe Will Need and Africa Will Own',
    date: 'October 5, 2025',
    tag: 'Energy',
