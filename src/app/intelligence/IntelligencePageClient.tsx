...
const products = [
  {
    ...
    desc: 'The OS that orchestrates the Harch Intelligence Distributed Mesh — 5 hubs, 250MW, 100% renewable. SENSE, THINK, ACT architecture for sovereign AI compute.',
    icon: Cpu,
    color: '#06B6D4',
  },
  {
    ...
    desc: '500MW AI-ready data center in Dakhla with 50K+ GPU clusters, submarine cable connectivity, and sovereign security framework.',
    icon: Server,
    color: '#8B5CF6',
  },
  {
    ...
    version: '/0.3',
    href: '/subsidiaries/intelligence',
    desc: 'GPU-as-a-Service 100% powered by renewable energy. H100/A100 clusters with carbon-aware scheduling and sovereign data residency.',
    icon: Zap,
    color: '#10B981',
  },
];
