    ...
    <div className="bg-[#1A1A1A]">
      ...
      <article className="prose-article max-w-[800px] mx-auto px-6 md:px-12 py-20 md:py-28">
        ...
        <FadeIn>
          ...
          <p className="text-[15px] text-[#BBBBBB] leading-[1.8] mb-6">
            Our model is deliberately vertical. Each Harch subsidiary is designed to feed the others. Harch Energy generates zero-carbon electricity that powers Harch Intelligence&apos;s data centers. Harch Mining extracts strategic minerals that Harch Technology processes into components. Harch Water provides the desalination capacity that enables Harch Ciment and Harch Agri to operate in water-stressed regions. This is not diversification for its own sake — it is an industrial ecosystem where each vertical strengthens the others, creating compounding efficiency and strategic resilience that standalone operators cannot match.
          </p>
        </FadeIn>
