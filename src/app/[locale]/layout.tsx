...
export async function generateMetadata({
  ...
  const title = isFr
    ? "Harch Corp | L'OS d'Infrastructure Souveraine de l'Afrique"
    : "Harch Corp | Africa's Sovereign Infrastructure OS";
  const description = isFr
    ? "Harch Corp S.A. est un conglomérat industriel marocain construisant la souveraineté industrielle de l'Afrique. Cloud GPU Conscient du Carbone (1 798 GPU), 2GW+ d'Énergie Renouvelable, Ciment, Technologie, Mines, Agriculture, Eau, Finance."
  ...
  const ogDescription = isFr
    ? "Conglomérat industriel marocain — pipeline d'investissement de 2,4 Md$ sur 8 filiales. Cloud GPU Conscient du Carbone (1 798 GPU), 2GW+ d'Énergie Renouvelable, Ciment, Mines, Agriculture, Eau, Finance. Construire la souveraineté industrielle de l'Afrique."
  ...
  const twitterDescription = isFr
    ? "Cloud GPU Conscient du Carbone | 1 798 GPU à ~47 gCO2/kWh. Pipeline d'Énergie Renouvelable 2GW+. IA Souveraine depuis le Maroc."
        ...
        subOrganization: [
          {
            ...
            description:
              "Carbon-Aware GPU Cloud — 1,798 GPUs across 5 Moroccan hubs at ~47 gCO2/kWh",
  ...
  return (
    <html lang={locale} suppressHydrationWarning>
      <head>
        ...
        <link rel="alternate" hrefLang="fr" href="https://www.harchcorp.com/fr" />
