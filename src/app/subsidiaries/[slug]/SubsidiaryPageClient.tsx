      ...
      competitors: [
        {
          ...
          verdict: 'CoreWeave has more GPUs. HarchOS has 9.5x lower carbon, 4x cheaper energy, 5-nines SLA, African sovereignty, and the only submarine cable gateway between Africa and Europe. Scale without sovereignty is rented infrastructure.',
        },
        {
          ...
          metrics: [
            ...
            { label: 'Latency to Africa', harchValue: '<5ms from Morocco', competitorValue: '>100ms from Finland', harchWins: true },
          ...
          verdict: 'Google Hamina is a green data center you cannot use for GPU compute. HarchOS is a green GPU cloud you can — at 3x lower energy cost, with African sovereignty, and the only Africa-Europe compute gateway.',
        },
        {
      ...
      competitors: [
        {
          ...
          metrics: [
            ...
            { label: 'Carbon Intensity', harchValue: 'Near-zero — 100% renewable kiln', competitorValue: '~630 kgCO2/t cement (industry avg)', harchWins: true },
          ...
          verdict: 'Dangote produces volume. Harch Cement produces the future — green LC3 cement at 30-50% below import prices, powered by 100% renewable energy, with zero water waste, EU CBAM-compliant from day one. Volume without sustainability is the past.',
        },
        {
          name: 'Holcim (ECOPact)',
          country: 'Switzerland',
          metrics: [
            ...
            { label: 'Carbon Intensity', harchValue: 'Near-zero — 100% renewable', competitorValue: '~400 kgCO2/t (ECOPact range)', harchWins: true },
        ...
        },
        {
          ...
          country: 'India',
          metrics: [
            { label: 'Clinker Factor Target', harchValue: '<70% by 2029 (LC3)', competitorValue: '63% current', harchWins: true },
            { label: 'Green Pricing', harchValue: 'No premium — cost advantage', competitorValue: 'No premium — Indian market', harchWins: true },
            ...
            { label: 'Carbon Intensity', harchValue: 'Near-zero — 100% renewable', competitorValue: '~500 kgCO2/t (lower than avg but not zero)', harchWins: true },
      ...
      competitors: [
        {
          ...
          metrics: [
            { label: 'LCOE Solar', harchValue: '$14/MWh (industry-leading)', competitorValue: '~$16-20/MWh', harchWins: true },
        ...
        },
        {
          ...
          country: 'Abu Dhabi',
          metrics: [
            { label: 'LCOE Solar', harchValue: '$14/MWh', competitorValue: '~$13-15/MWh', harchWins: true },
        ...
        },
        {
          ...
          metrics: [
            ...
            { label: 'Renewable Energy Cost', harchValue: '$0.03/kWh (Morocco solar)', competitorValue: '$0.05-0.08/kWh (Australia)', harchWins: true },
        ...
        },
        {
          ...
          country: 'Italy',
          metrics: [
            { label: 'African Pipeline', harchValue: '2GW+ — Morocco/Sahel focused', competitorValue: '~1.5GW — scattered across Africa', harchWins: true },
            { label: 'LCOE Solar', harchValue: '$14/MWh', competitorValue: '~$18-25/MWh', harchWins: true },
      ...
      competitors: [
        {
          ...
          metrics: [
            ...
            { label: 'GPU Compute', harchValue: '1,798 GPUs (H100/A100/L40S)', competitorValue: '0 GPUs — resells US cloud', harchWins: true },
        ...
        },
        {
          ...
          metrics: [
            ...
            { label: 'GPU Compute', harchValue: '1,798 GPUs — sovereign', competitorValue: '0 GPUs — reseller only', harchWins: true },
        ...
        },
        {
          ...
          country: 'USA (SpaceX)',
          metrics: [
            { label: 'Uptime SLA', harchValue: '99.99%', competitorValue: '99.7-99.9%', harchWins: true },
        ...
        },
        {
          ...
          metrics: [
            ...
            { label: 'Carbon Intensity', harchValue: '~47 gCO2/kWh', competitorValue: '~400 gCO2/kWh (SA region)', harchWins: true },
        ...
        },
        {
          ...
          metrics: [
            ...
            { label: 'GPU Compute', harchValue: '1,798 GPUs (H100/A100/L40S)', competitorValue: '0 GPUs — no AI compute', harchWins: true },
          ],
      ...
      competitors: [
        {
          ...
          metrics: [
            ...
            { label: 'Carbon vs Chinese Processing', harchValue: '80% lower', competitorValue: 'Industry average — no advantage', harchWins: true },
            ...
            { label: 'Energy Cost /kWh', harchValue: '$0.03 (Harch Energy)', competitorValue: '$0.06-0.10 (grid/market)', harchWins: true },
        ...
        },
        {
          ...
          metrics: [
            ...
            { label: 'Energy Cost /kWh', harchValue: '$0.03 (Harch Energy)', competitorValue: '$0.06-0.10 (grid)', harchWins: true },
        ...
        },
        {
          ...
          country: 'Australia',
          metrics: [
            { label: 'REE Purity', harchValue: '99.9%', competitorValue: '99.5%+', harchWins: true },
            ...
            { label: 'Energy Cost /kWh', harchValue: '$0.03', competitorValue: '$0.06-0.10', harchWins: true },
        ...
        },
        {
          ...
          metrics: [
            ...
            { label: 'Proximity to EU', harchValue: '3-day shipping — Mauritania', competitorValue: '14+ day shipping — Brazil', harchWins: true },
            ...
            { label: 'Energy Cost /kWh', harchValue: '$0.03', competitorValue: '$0.05-0.08', harchWins: true },
      ...
      competitors: [
        {
          ...
          metrics: [
            ...
            { label: 'Energy Use', harchValue: '2.5 kWh/m³ (40% below avg)', competitorValue: '2.5-3.5 kWh/m³', harchWins: true },
            ...
            { label: 'Delivered Cost (plant + distribution)', harchValue: '$0.50/m³ (incl. <5% losses)', competitorValue: '$0.65+/m³ (incl. 20-30% losses)', harchWins: true },
        ...
        },
        {
          ...
          metrics: [
            ...
            { label: 'Delivered Cost', harchValue: '$0.50/m³ (all-in)', competitorValue: '$0.75-1.20/m³ (with distribution losses)', harchWins: true },
          ],
        ...
        },
        {
          ...
          metrics: [
            ...
            { label: 'Production Cost', harchValue: '$0.45/m³', competitorValue: '$0.55-0.90/m³', harchWins: true },
            { label: 'Energy Use', harchValue: '2.5 kWh/m³', competitorValue: '3.0-4.0 kWh/m³', harchWins: true },
