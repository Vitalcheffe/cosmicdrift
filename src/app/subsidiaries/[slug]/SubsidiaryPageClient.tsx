...
export default function SubsidiaryPageClient({ slug }: { slug: string }) {
  const subsidiaryData: Record<string, SubsidiaryInfo> = {
    intelligence: {
      ...
      heroImage: '/images/real/intel-datacenter.jpg',
      sectionImage1: '/images/real/intel-server-room.jpg',
      sectionImage2: '/images/real/intel-control-room.jpg',
      sectionImage3: '/images/real/intel-gpu-rack.jpg',
      sectionImage4: '/images/real/intel-submarine-cable.jpg',
    ...
    cement: {
      ...
      heroImage: '/images/real/cement-construction.jpg',
      sectionImage1: '/images/real/cement-factory.jpg',
      sectionImage2: '/images/real/cement-quarry.jpg',
      sectionImage3: '/images/real/cement-kiln.jpg',
      sectionImage4: '/images/real/cement-industrial.jpg',
      ...
      strategicContext: 'West Africa faces a fundamental construction materials deficit. The region imports over 15 million tonnes of cement annually, paying premium prices that inflate infrastructure costs by 40-70% compared to markets with domestic production. Gambia, with a population of 2.5 million and a GDP growing at 6% annually, currently imports 100% of its cement — a structural vulnerability that increases with every infrastructure project. The African Development Bank estimates that West Africa needs $130 billion in infrastructure investment through 2030, all of which requires cement. Harch Ciment\'s 500kT/yr facility captures a significant share of this demand while building domestic industrial capacity that strengthens economic sovereignty.',
    ...
    energy: {
      ...
      heroImage: '/images/real/energy-solar-panels.jpg',
      sectionImage1: '/images/real/energy-wind-turbines.jpg',
      sectionImage2: '/images/real/energy-solar-farm.jpg',
      sectionImage3: '/images/real/energy-hydrogen.jpg',
      sectionImage4: '/images/real/energy-power-grid.jpg',
      ...
      strategicAdvantages: [
        ...
        { title: 'Captive Demand from Harch Verticals', desc: 'Guaranteed offtake from Harch Intelligence (500MW), Harch Ciment, Harch Mining, and Harch Water provides revenue floor that derisks project finance and enables better debt terms.' },
    ...
    technology: {
      ...
      heroImage: '/images/real/tech-satellite.jpg',
      sectionImage1: '/images/real/tech-ai-neural.jpg',
      sectionImage2: '/images/real/tech-cyber.jpg',
      sectionImage3: '/images/real/tech-circuit.jpg',
      sectionImage4: '/images/real/tech-network.jpg',
    ...
    mining: {
      ...
      heroImage: '/images/real/mining-open-pit.jpg',
      sectionImage1: '/images/real/mining-excavator.jpg',
      sectionImage2: '/images/real/mining-processing.jpg',
      sectionImage3: '/images/real/mining-heavy-equipment.jpg',
      sectionImage4: '/images/real/mining-smelter.jpg',
    ...
    agriculture: {
      ...
      heroImage: '/images/real/agri-aerial-field.jpg',
      sectionImage1: '/images/real/agri-greenhouse.jpg',
      sectionImage2: '/images/real/agri-precision.jpg',
      sectionImage3: '/images/real/agri-crops.jpg',
      sectionImage4: '/images/real/agri-farm.jpg',
    ...
    water: {
      ...
      heroImage: '/images/real/water-treatment.jpg',
      sectionImage1: '/images/real/water-desalination.jpg',
      sectionImage2: '/images/real/water-dam.jpg',
      sectionImage3: '/images/real/water-reservoir.jpg',
      sectionImage4: '/images/real/water-pipes.jpg',
