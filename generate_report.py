...
market_data = [
    [TH('Country'), TH('Data Centers'), TH('Capacity (MW)'), TH('Key Notes')],
...
wind_data = [
    [TH('Parameter'), TH('Value'), TH('Source')],
...
cable_data = [
    [TH('Cable System'), TH('Capacity'), TH('Status'), TH('Connects To')],
...
land_data = [
    [TH('Zone Type'), TH('Price (MAD/m<super>2</super>)'), TH('Price (EUR/m<super>2</super>)'), TH('Notes')],
...
dc_specs = [
    [TH('Specification'), TH('Phase 1'), TH('Phase 2 (Full Build)')],
...
gpu_data = [
    [TH('Component'), TH('Unit Price (USD)'), TH('Power (W)'), TH('Notes')],
...
capex_data = [
    [TH('Component'), TH('Low ($M)'), TH('High ($M)'), TH('Notes')],
...
opex_data = [
    [TH('Cost Item'), TH('Annual Cost ($M)'), TH('Notes')],
...
tax_data = [
    [TH('Tax'), TH('DWAFZ Advantage'), TH('Duration'), TH('Standard Rate')],
...
swot_data = [
    [TH('Category'), TH('Factor'), TH('Impact')],
...
infra_data = [
    [TH('Project'), TH('Investment'), TH('Delivery'), TH('Status')],
...
comp_data = [
    [TH('Project / Operator'), TH('Location'), TH('Capacity'), TH('Status / Differentiator')],
...
roadmap_data = [
    [TH('Phase'), TH('Timeline'), TH('Scope'), TH('Key Milestones')],
...
contacts_data = [
    [TH('Organization'), TH('Role'), TH('Contact')],
