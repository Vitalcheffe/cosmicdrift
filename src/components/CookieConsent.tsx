...
export function CookieConsent() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4 md:p-6">
      <div className="max-w-[1400px] mx-auto bg-white border border-[rgba(0,0,0,0.06)] rounded-xl p-5 md:p-6 flex flex-col sm:flex-row items-start sm:items-center gap-4 shadow-2xl shadow-black/10">
